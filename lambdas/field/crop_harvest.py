...
def handler(event, context):
    ...
    try:
        item = table.update_item(
            Key={"id": crop_id},
            UpdateExpression="SET cultivar = :cultivar, cultivar_start = :cultivar_start, cultivar_end = :cultivar_end",
        ...
        metrics.add_metric(
            name="SuccessfulCropHarvested", unit=MetricUnit.Count, value=1
        )
